...
def build_recommendation(prediction: PredictionLabel) -> str:
    ...
    if prediction == "Normal":
        guidance = (
            "No obvious pneumonia pattern was detected on this chest X-ray screening. "
            "If you have symptoms such as cough, fever, shortness of breath, or chest "
            "discomfort, please consult a doctor for further evaluation."
        )
    else:
        guidance = (
