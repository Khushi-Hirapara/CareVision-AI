...
export function ConfidenceInterpretation({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl border border-slate-200 bg-gradient-to-br from-white to-slate-50/70 p-4 sm:p-5",
        className,
      )}
    >
      ...
      />
        <div className="min-w-0 flex-1 space-y-2 pt-1">
          ...
          <p className={cn("text-xl font-bold", tierAccentClass(interpretation.tier))}>
