...
export function HeatmapPanel({
  ...
  return (
    ...
    >
      <div className="border-b border-slate-100 bg-slate-50/80 px-4 py-3 dark:border-slate-700/70 dark:bg-slate-950/50">
      ...
      {heatmapUrl ? (
        <>
          <div className="relative aspect-square bg-slate-900/5 dark:bg-slate-950/60">
          ...
          {affectedArea ? (
            <div className="border-t border-slate-100 bg-slate-50/90 px-3 py-3 dark:border-slate-700/70 dark:bg-slate-950/40">
              <ExplainabilityPanel
            ...
            <p className="px-3 py-2 text-[10px] text-slate-400 sm:text-xs dark:text-slate-500">
              Highlights regions that influenced the model prediction.
            </p>
          )}
        </>
      ) : (
        <div className="flex aspect-square flex-col items-center justify-center gap-2 bg-slate-50/80 p-6 text-center dark:bg-slate-950/40">
